...
def compute_velocity(position, goal, controler, thymio_angle, goal_reached=False):
  ...
  if not (goal_reached):
    ...
    motor_L = (controler.Kp_dist * (180-abs(angle_error))) + controler.Kp_angle * angle_error
    motor_R = (controler.Kp_dist * (180-abs(angle_error))) - controler.Kp_angle * angle_error
